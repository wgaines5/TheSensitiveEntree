...
public class BokChoy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_bokchoy);

    }

    //Back button onClick
    public void onClickBack(View view){
        Intent myintent = new Intent(BokChoy.this, RecipeListings.class);
        BokChoy.this.startActivity(myintent);
    }

    //Ingredient substitutions button onClick
    public void onClickIngredientSubs(View view){
        Intent myintent = new Intent(BokChoy.this, IngredientSubs.class);
        BokChoy.this.startActivity(myintent);
    }

    //Resource button onClick
    public void onClickResource(View view){
        Intent myintent = new Intent(BokChoy.this, Resources.class);
        BokChoy.this.startActivity(myintent);
    }
}
