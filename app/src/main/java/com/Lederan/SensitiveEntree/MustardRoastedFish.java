...
public class MustardRoastedFish extends AppCompatActivity {
    ...
    public void onClickBack(View view){
        Intent myintent = new Intent(MustardRoastedFish.this, RecipeListings.class);
        MustardRoastedFish.this.startActivity(myintent);
    }

    //Ingredient substitutions button onClick
    public void onClickIngredientSubs(View view){
        Intent myintent = new Intent(MustardRoastedFish.this, IngredientSubs.class);
        MustardRoastedFish.this.startActivity(myintent);
    }

    //Resource button onClick
    public void onClickResource(View view){
        Intent myintent = new Intent(MustardRoastedFish.this, Resources.class);
        MustardRoastedFish.this.startActivity(myintent);
    }
}
