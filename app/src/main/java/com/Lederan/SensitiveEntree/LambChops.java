...
public class LambChops extends AppCompatActivity {
    ...
    public void onClickBack(View view){
        Intent myintent = new Intent(LambChops.this, RecipeListings.class);
        LambChops.this.startActivity(myintent);
    }

    //Ingredient substitutions button onClick
    public void onClickIngredientSubs(View view){
        Intent myintent = new Intent(LambChops.this, IngredientSubs.class);
        LambChops.this.startActivity(myintent);
    }

    //Resource button onClick
    public void onClickResource(View view){
        Intent myintent = new Intent(LambChops.this, Resources.class);
        LambChops.this.startActivity(myintent);
    }
}
