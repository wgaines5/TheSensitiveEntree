...
public class CreamyShrimpSkillet extends AppCompatActivity {
    ...
    public void onClickBack(View view){
        Intent myintent = new Intent(CreamyShrimpSkillet.this, RecipeListings.class);
        CreamyShrimpSkillet.this.startActivity(myintent);
    }

    //Ingredient substitutions button onClick
    public void onClickIngredientSubs(View view){
        Intent myintent = new Intent(CreamyShrimpSkillet.this, IngredientSubs.class);
        CreamyShrimpSkillet.this.startActivity(myintent);
    }

    //Resource button onClick
    public void onClickResource(View view){
        Intent myintent = new Intent(CreamyShrimpSkillet.this, Resources.class);
        CreamyShrimpSkillet.this.startActivity(myintent);
    }
}
