...
public class LambScewers extends AppCompatActivity {
    ...
    public void onClickBack(View view){
        Intent myintent = new Intent(LambScewers.this, RecipeListings.class);
        LambScewers.this.startActivity(myintent);
    }

    //Ingredient substitutions button onClick
    public void onClickIngredientSubs(View view){
        Intent myintent = new Intent(LambScewers.this, IngredientSubs.class);
        LambScewers.this.startActivity(myintent);
    }

    //Resource button onClick
    public void onClickResource(View view){
        Intent myintent = new Intent(LambScewers.this, Resources.class);
        LambScewers.this.startActivity(myintent);
    }
}
