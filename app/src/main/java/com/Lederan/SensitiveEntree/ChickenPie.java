...
public class ChickenPie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_chickenPie);

    }

    //Back button onClick
    public void onClickBack(View view){
        Intent myintent = new Intent(ChickenPie.this, RecipeListings.class);
        ChickenPie.this.startActivity(myintent);
    }

    //Ingredient substitutions button onClick
    public void onClickIngredientSubs(View view){
        Intent myintent = new Intent(ChickenPie.this, IngredientSubs.class);
        ChickenPie.this.startActivity(myintent);
    }

    //Resource button onClick
    public void onClickResource(View view){
        Intent myintent = new Intent(ChickenPie.this, Resources.class);
        ChickenPie.this.startActivity(myintent);
    }
}
