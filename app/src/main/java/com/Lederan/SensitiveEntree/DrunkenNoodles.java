...
public class DrunkenNoodles extends AppCompatActivity {
    ...
    public void onClickBack(View view){
        Intent myintent = new Intent(DrunkenNoodles.this, RecipeListings.class);
        DrunkenNoodles.this.startActivity(myintent);
    }

    //Ingredient substitutions button onClick
    public void onClickIngredientSubs(View view){
        Intent myintent = new Intent(DrunkenNoodles.this, IngredientSubs.class);
        DrunkenNoodles.this.startActivity(myintent);
    }

    //Resource button onClick
    public void onClickResource(View view){
        Intent myintent = new Intent(DrunkenNoodles.this, Resources.class);
        DrunkenNoodles.this.startActivity(myintent);
    }
}
