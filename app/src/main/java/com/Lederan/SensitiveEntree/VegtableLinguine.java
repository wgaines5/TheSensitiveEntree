...
public class VegtableLinguine extends AppCompatActivity {
    ...
    public void onClickBack(View view){
        Intent myintent = new Intent(VegtableLinguine.this, RecipeListings.class);
        VegtableLinguine.this.startActivity(myintent);
    }

    //Ingredient substitutions button onClick
    public void onClickIngredientSubs(View view){
        Intent myintent = new Intent(VegtableLinguine.this, IngredientSubs.class);
        VegtableLinguine.this.startActivity(myintent);
    }

    //Resource button onClick
    public void onClickResource(View view){
        Intent myintent = new Intent(VegtableLinguine.this, Resources.class);
        VegtableLinguine.this.startActivity(myintent);
    }
}
